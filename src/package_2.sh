...
pip3 install pymysql pyvirtualdisplay faker-e164 Faker PySocks stem  bs4 ConfigParser lxml  speechrecognition requests pyvirtualdisplay pydub pyautogui emojis emoji image pandas Pillow  cv2 easyocr
